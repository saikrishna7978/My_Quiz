...
class Constants {
  ...
  // Pink
  static Color lightGreen = Color(0xFFEBFCF7);
  // Pink
  static Color lightPink2 = Color(0xFFFFD6E9);

  // Yellow
  static Color lightYellow = Color(0xFFFFF5E5);

  // Violet
  static Color lightViolet = Color(0xFFFAF2FF);
  // Violet
  static Color lightViolet2 = Color(0xFFE8D9FC);
