...
class GeneralStudies extends StatefulWidget {
  @override
  _GeneralStudiesState createState() => _GeneralStudiesState();
}

class _GeneralStudiesState extends State<GeneralStudies> {
  @override
  void initState() {
    super.initState();
  }
