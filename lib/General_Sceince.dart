...
class GeneralScience extends StatefulWidget {
  @override
  _GeneralScienceState createState() => _GeneralScienceState();
}

class _GeneralScienceState extends State<GeneralScience> {
  @override
  void initState() {
    super.initState();
  }
